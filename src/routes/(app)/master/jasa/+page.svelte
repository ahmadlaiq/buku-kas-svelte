...
{/if}
{#if form?.success}
  <div class="alert alert-success" style="margin-bottom: 1rem;">Berhasil menyimpan data jasa!</div>
{/if}
...
<div class="toolbar">
  <div class="search-box">
    <input
      type="text"
      class="form-control"
      placeholder="Cari nama jasa, kategori..."
                ...
                <form method="POST" action="?/delete" use:enhance={() => {
                  ...
                  <button
                    ...
                    on:click|preventDefault={(e) => {
                      if (confirm('Yakin ingin menghapus jasa ini?')) e.currentTarget.form?.requestSubmit();
                    }}
                  >Hapus</button>
                </form>
              </div>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="?/create" use:enhance={() => {
        ...
        <div class="form-group">
          ...
          <input type="text" id="nama" name="nama" class="form-control" required placeholder="Contoh: Potong Poni" />
        </div>
        <div class="form-group">
          <label for="kategori" class="form-label">Kategori</label>
          <input type="text" id="kategori" name="kategori" class="form-control" placeholder="Contoh: Potong Rambut, Hair Treatment" />
        </div>
        <div class="form-group">
        ...
        <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
          ...
          <button type="submit" class="btn btn-primary" style="flex: 1;" disabled={loading}>{loading ? 'Menyimpan...' : 'Simpan Jasa'}</button>
        </div>
      </form>
    </div>
  </div>
...
{#if showEditModal && editItem}
  <div class="modal">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="text-xl font-bold">Edit Jasa</h2>
      ...
      <form method="POST" action="?/update" use:enhance={() => {
        ...
        <div class="form-group">
          <label for="edit-nama" class="form-label">Nama Jasa *</label>
